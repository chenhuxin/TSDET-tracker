function net_online2=second_train_tracking(opts,varargin,config)
global objSize;
num_channels=64;
...
net_online2=initNet(target_sz1);
...
net_online2= cnn_train_dag(net_online2, imdb, input,getBatchWrapper(bopts), ...%用dagnn框架训练网络
                     trainOpts, ...
                     'train', train, ...                     
                     opts.train) ;
