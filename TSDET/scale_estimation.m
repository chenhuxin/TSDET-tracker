function target_szU = scale_estimation(im,pos,target_sz,window_szo,...
    net1,net_online2,coeff,meanImg,featPCA1st)
num_channels=64;
threshold=0.15;
...
for i=1:length(scale)
    ...
    net_online2.eval({'input1',gpuArray(featPCA),'input2',gpuArray(featPCA1st)});
    regression_map=gather(net_online2.vars(10).value);
