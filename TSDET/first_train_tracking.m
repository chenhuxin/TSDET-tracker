function net_online1 =first_train_tracking(opts,varargin,config)
global objSize;
num_channels=64;
...
net_online1=initNet(target_sz1);
...
net_online1= cnn_train_dag(net_online1, imdb, input,getBatchWrapper(bopts), ...%用dagnn框架训练网络
                     trainOpts, ...
                     'train', train, ...                     
                     opts.train) ;
